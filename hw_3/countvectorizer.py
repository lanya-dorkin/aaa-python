class CountVectorizer:
    ...
    This class provides methods for transforming a list of text documents into a term-document matrix where
    each row represents a document and each column represents a unique word in the corpus.
    ...
    def split_document(self, document: str) -> list[str]:
        ...
        document = self.remove_chars(document)
